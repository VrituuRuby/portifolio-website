...
<div class="flex flex-col gap-1 py-4">
	...
	<div class="flex gap-4 md:text-lg">
		<div class="flex flex-col flex-1 p-2 rounded-lg bg-gray-100 shadow-lg gap-2">
			...
			<div class="flex flex-col gap-2 justify-center sm:flex-row sm:flex-wrap">
				{#each frontend as skill}
					<div class="flex gap-2 p-2 font-rubik text-gray-800 bg-gray-300 rounded-lg">
